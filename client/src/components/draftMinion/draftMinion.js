...
class DraftMinion extends Component {
  ...
  onDragEnd = result => {
    ...
    if (source.droppableId === 'droppable' && destination.droppableId === "droppable2" && (this.state.player1Turn)) {
      ...
      API.draft1Minion(result.droppable, result[destination.droppableId])
    }
    ...
    if (source.droppableId === 'droppable' && destination.droppableId === "droppable3" && (this.state.player2Turn)) {
      ...
      API.draft2Minion(result.droppable, result[destination.droppableId])
    }
        ...
        <div className="container">
          ...
          <div className="row1">
            ...
            <div className="minionHeader">
              ...
              <h3 className="headerText">Current Turn: {this.state.player1name}</h3>
            </div>
        ...
        <DragDropContext onDragEnd={this.onDragEnd}>
          <div className="container">
            ...
            <div className="row1">
              ...
              <div className="minionHeader">
                <h1 className="headerText">Choose your minions</h1>
                <h3 className="headerText">Current Turn: {this.state.player2name}</h3>
              </div>
